...
class FirstScreenGoMainScreenState extends FirstScreenState {
  ...
  const FirstScreenGoMainScreenState({required this.id, required this.nom, required this.adresse, required this.username});

  @override
  List<Object> get props => [id, nom, username, adresse];  
}
