                  ...
                  children: [
                    ListTile(
                      ...
                      title: TypoText(
                          ...
                          .longCast(),
                      subtitle: TypoText(
                              text: userModel.adresse.toString(),
                              color: AppColors.colorTextInput)
                          .short(),
                    )
                  ],
    ...
    return BlocProvider(
      ...
      child: Scaffold(
          ...
          builder: (context, state) {
            return SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                     Container(height: 5, width: double.infinity , decoration: BoxDecoration(color: AppColors.red)),
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              border: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide.none),
                              hintText: AppLocalizations.of(context)!.acc_number,
                              hintStyle: GoogleFonts.inter(
                                  color: Colors.grey,
                                  fontSize: 15,
                                  fontWeight: FontWeight.w400),
                          ...
                          ButtonComponent(
                            onPressed: () {
                              if (formKeyCotisation.currentState!.validate()) {
                                final cotisationModel = CotisationModel(
                                    ...
                                    idClient: int.tryParse(
                                        idClient.trim())!,
                                    idUser: userModel.id!,
                                    mobile: numeroClientController.text.trim(),
                                    numCompte: numCompteClientController.text.trim(),
        ...
        bottomSheet: Padding(
          ...
          child: Container(height: 5, width: double.infinity , decoration: BoxDecoration(color: AppColors.red),),
        ),
      ),
    );
  }
